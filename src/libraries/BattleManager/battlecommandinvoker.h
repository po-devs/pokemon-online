...
#define end(func, ...) \
    ...
    start(UseAttack, onUseAttack, int spot, int attack, bool silent, bool special) end(onUseAttack, spot, attack, silent, special)
    start(UsePP, onUsePP, int spot, int attack, int ppsum) end(onUsePP, spot, attack, ppsum)
    ...
    start(CappedStat, onCappedStat, int spot, int stat, bool maxi) end(onCappedStat, spot, stat, maxi)
    ...
    start(StartTerrain, onStartTerrain, int spot, int terrain, bool ability) end(onStartTerrain, spot, terrain, ability)
