...
#define end(func, ...) \
    ...
    start(WontGoHigher, onMaximumBoost, int spot, int stat) end(onMaximumBoost, spot, stat)
    start(WontGoLower, onMinimumBoost, int spot, int stat) end(onMinimumBoost, spot, stat)
