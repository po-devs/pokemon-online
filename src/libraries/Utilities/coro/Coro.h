...
#define coro_transfer(a,b) Coro_switchTo_((a)->p,(b)->p)
#define coro_func CoroStartCallback
#define coro_destroy(a) Coro_free((a)->p)
#define coro_create(a) ((a)->p = Coro_new())
#define coro_start(main, other, func, param) Coro_startCoro_((main)->p, (other)->p, param, func)
#define coro_main(a) Coro_initializeMainCoro((a)->p)
