...
namespace Pokemon
{
   ...
   That allows you to do PokemonInfo::Picture(pokenum, (Gender)GenderAvail(pokenum)) */
    ...
    enum Name
    {
        ...
        Passimian,
        Oranguru,
        SpikyBlueAnemoneThing,
        SpikyBlueAnemoneThingEvo2,
        AnchorThing,
        SpiderCrabThing,
        SpiderCrabThingEvo2,
        Tapu_Purple,
        ...
        Rotom_Frost = Rotom + (3 << 16),
        Rotom_Wash = Rotom + (4 << 16),
        Rotom_Fan = Rotom + (5 << 16),
        Deoxys_Attack = Deoxys + (1 << 16),
        Deoxys_Defense = Deoxys + (2 << 16),
        Deoxys_Speed = Deoxys + (3 << 16),
        Wormadam_Sandy = Wormadam + (1 << 16),
        Wormadam_Trash = Wormadam + (2 << 16),
        Giratina_Origin = Giratina + (1 << 16),
        Shaymin_Sky = Shaymin + (1 << 16),
        Meloetta_Pirouette = Meloetta + (1 << 16),
        Thundurus_Therian = Thundurus + (1 << 16),
        Landorus_Therian = Landorus + (1 << 16),
        Tornadus_Therian = Tornadus + (1 << 16),
        Darmanitan_Zen = Darmanitan + (1 << 16),
        Pichu_SpikyEared = Pichu + (1 << 16),
        Kyurem_White = Kyurem + (1 << 16),
        Kyurem_Black = Kyurem + (2 << 16),
        Keldeo_Resolute = Keldeo + (1 << 16),
        Genesect_Douse = Genesect + (1 << 16),
        Genesect_Shock = Genesect + (2 << 16),
        Genesect_Burn = Genesect + (3 << 16),
        Genesect_Chill = Genesect + (4 << 16),
        Meowstic_F = Meowstic + (1 << 16),
        Pumpkaboo_Small = Pumpkaboo + (1 << 16),
        Pumpkaboo_Large = Pumpkaboo + (2 << 16),
        Pumpkaboo_Super = Pumpkaboo + (3 << 16),
        Gourgeist_Small = Gourgeist + (1 << 16),
        Gourgeist_Large = Gourgeist + (2 << 16),
        Gourgeist_Super = Gourgeist + (3 << 16),
        Floette_Eternal = Floette + (5 << 16),
        Hoopa_Unbound = Hoopa + (1 << 16),
        ...
        Persian_Alolan = Persian + (1 << 16),
        Raichu_Alolan = Raichu + (1 << 16),
        Exeggutor_Alolan = Exeggutor + (1 << 16),
        Cubone_Alolan = Cubone + (1 << 16),
        Marowak_Alolan = Marowak + (1 << 16),
        Grimer_Alolan = Grimer + (1 << 16),
        Muk_Alolan = Muk + (1 << 16),
        Diglett_Alolan = Diglett + (1 << 16),
        Dugtrio_Alolan = Dugtrio + (1 << 16),
        Geodude_Alolan = Geodude + (1 << 16),
