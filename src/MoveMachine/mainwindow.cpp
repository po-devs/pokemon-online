...
void PokeMovesDb::init()
{
    ...
    for (int i =0; i < PokemonInfo::TrueCount(5); i++) {
        ...
        if (preEvo != 0) {
            ...
            pokes[i].gens[2].moves[PreEvoMoves].unite(pokes[preEvo].gens[2].moves[EggMoves]);
            ...
            pokes[i].gens[2].moves[PreEvoMoves].subtract(pokes[i].gens[2].moves[EggMoves]);
            ...
            pokes[i].gens[3].moves[PreEvoMoves].unite(pokes[preEvo].gens[3].moves[EggMoves]);
            ...
            pokes[i].gens[3].moves[PreEvoMoves].subtract(pokes[i].gens[3].moves[EggMoves]);
            ...
            pokes[i].gens[4].moves[PreEvoMoves].unite(pokes[preEvo].gens[4].moves[EggMoves]);
            pokes[i].gens[4].moves[PreEvoMoves].unite(pokes[preEvo].gens[4].moves[DreamWorldMoves]);
            ...
            pokes[i].gens[4].moves[PreEvoMoves].subtract(pokes[i].gens[4].moves[EggMoves]);
            pokes[i].gens[4].moves[PreEvoMoves].subtract(pokes[i].gens[4].moves[DreamWorldMoves]);
...
//    exit(0);
    ...
    **********************/
    ...
    for (int i = 0; i < MoveInfo::NumberOfMoves(GEN_MAX); i++)
    {
