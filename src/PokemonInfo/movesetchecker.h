...
public:
    ...
    static bool isValid(const Pokemon::uniqueId &pokeid, int gen, const QSet<int> &moves, QSet<int> *invalid_moves=NULL);
    static bool isValid(const Pokemon::uniqueId &pokeid, int gen, int move1,int move2, int move3, int move4, QSet<int> *invalid_moves=NULL);
